...
def get_price_data(pair_name, granularity):
    df = pd.read_pickle(utils.get_his_data_filename(pair_name, granularity))
...
def run():
    ...
    i_pair = instrument.Instrument.get_instrument_dict()[pair_name]
